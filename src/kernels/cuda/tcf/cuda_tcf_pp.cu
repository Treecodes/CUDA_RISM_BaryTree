...
__global__ 
static void CUDA_TCF_PP_Lagrange(double eta, double kap, double kap_eta_2, int cluster_num_sources, int cluster_idx_start,
    ...
    struct RunParams *run_params, double *potential, int gpu_async_stream_id)
{
    ...
    CUDA_TCF_PP_Lagrange<<<nblocks,nthreads>>>(eta,kap,kap_eta_2,cluster_num_sources, cluster_idx_start,
