...
__global__ 
void  CUDA_TCF_CP_Lagrange(FLOAT kap, int batch_num_sources, int batch_idx_start,
    ...
    FLOAT *cluster_x, FLOAT *cluster_y, FLOAT *cluster_z, FLOAT *temporary_potential)
{
